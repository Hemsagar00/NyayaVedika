...
function renderDrafting() {
  ...
  <section class="page-hero" id="drafting-hero">
    <div class="container">
      ...
      <p class="page-hero-sub">Generate court-ready petitions, analyze documents, and explore legal grounds — powered by Claude AI.</p>
    </div>
  </section>
  <div class="container">
...
function renderForAdvocates() {
  const segments = [
    { id: 'solo', title: 'Solo Practitioners', desc: 'You handle everything — research, drafting, filing, court appearances. NyayaVedika gives you the drafting capacity of a junior without the overhead.', cases: ['Bail applications for District & Sessions Courts', 'Writ petitions under Article 226', 'Revenue appeals (ROR mutations, land disputes)', 'Civil suit drafts (partition, injunctions, specific performance)'] },
    { id: 'chambers', title: 'Chambers & Associates', desc: 'Your chambers handles a steady volume of cases. NyayaVedika lets your team produce consistent, well-structured drafts in a fraction of the time.', cases: ['Standardize brief formats across associates', 'Handle multiple revenue appeals in parallel', 'Quick turnaround on bail and remand applications', 'Build a template library for your practice areas'] },
    { id: 'firms', title: 'Law Firms', desc: 'For firms handling high-volume litigation or establishing legal-tech-forward workflows. NyayaVedika integrates with your document pipeline.', cases: ['SLPs before the Supreme Court', 'Multi-party property and partition suits', 'Batch drafting for similar case types', 'Compliance and audit-ready document trails'] }
  ];
...
function renderPricing() {
  const plans = [
    { id: 'starter', name: 'Starter', audience: 'Solo Practitioners', price: '₹499', period: '/month', features: ['5 drafts per month', 'All document types', 'DOCX export', 'Email support', 'Basic templates'], cta: 'Coming Soon', highlight: false },
    { id: 'chambers', name: 'Chambers', audience: 'Small Teams', price: '₹1,499', period: '/month', features: ['25 drafts per month', 'All document types', 'DOCX + PDF export', 'Priority support', 'Custom templates', 'Team sharing'], cta: 'Early Access', highlight: true },
    { id: 'firm', name: 'Firm', audience: 'Large Teams', price: 'Custom', period: '', features: ['Unlimited drafts', 'All document types', 'API access', 'Dedicated support', 'Custom integrations', 'Audit trail & compliance', 'On-premise option'], cta: 'Contact Us', highlight: false }
  ];
  ...
  <section class="security-section" id="security-content">
    <div class="container">
      <div class="security-grid">
        <div class="security-card" id="sec-encryption"><div class="security-icon">🔒</div><h3>Encryption at Rest & in Transit</h3><p>All data is encrypted using AES-256 at rest and TLS 1.3 in transit. Your case files and drafts are protected at every stage.</p></div>
        <div class="security-card" id="sec-retention"><div class="security-icon">🗑️</div><h3>Minimal Data Retention</h3><p>Uploaded documents are processed and not retained beyond your active session unless you explicitly save them to your account.</p></div>
        <div class="security-card" id="sec-access"><div class="security-icon">🛡️</div><h3>Access Controls</h3><p>Role-based access for team accounts. Only authorized members of your chambers or firm can view or edit shared drafts.</p></div>
        <div class="security-card" id="sec-compliance"><div class="security-icon">📋</div><h3>Compliance Ready</h3><p>Built with Indian data protection considerations in mind. Actively working toward compliance with applicable regulations.</p></div>
      </div>
      <div class="legal-disclaimer" id="legal-disclaimer">
        ...
        <div class="disclaimer-content">
          ...
          <ul>
            ...
            <li>NyayaVedika provides AI assistance. The platform does not guarantee the accuracy, completeness, or legal sufficiency of any generated document.</li>
            <li>No attorney-client relationship is created by using NyayaVedika.</li>
            <li>The advocate using NyayaVedika bears full professional responsibility for all documents filed.</li>
          </ul>
